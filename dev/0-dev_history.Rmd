...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "Herramientas para la comunicación de la Dirección Nacional de Mercados y Estadística.",
    `Authors@R` = person(given = "Pablo", family = "Tiscornia", 
...
usethis::use_mit_license("Pablo Tiscornia")
```
...
```{r}
## Cargo dataset al paquete
#usethis::use_data_raw()

### Documento la base
usethis::use_r("toy_evyth")
```
